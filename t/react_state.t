...
is_deeply( $state->react( { key => 'TestCase', a => 5 }, { field => 'a' } ),
           { key => 'TestCase', a => 5, subject => 'TestCase: a changed: 0 => 5', state_change => 5, state_init => 1 },
